...
energy_valid_set_imp.to_csv(os.path.join(path_cleaned,'energy\valid_set_imp.csv'), index = False)
...
torch.save(train_loader, os.path.join(path_cleaned, 'energy\train_loader.pt'))
torch.save(valid_loader, os.path.join(path_cleaned, 'energy\valid_loader.pt'))
torch.save(train_seq, os.path.join(path_cleaned, 'energy\train_seq.pt'))
torch.save(valid_seq, os.path.join(path_cleaned, 'energy\valid_seq.pt'))
torch.save(test_seq, os.path.join(path_cleaned, 'energy\test_seq.pt'))
torch.save(valid_loader, os.path.join(path_cleaned, 'energy\valid_loader.pt'))
...
temp_train_set.to_csv(os.path.join(path_cleaned, 'temperature\train_set.csv', index = False))
temp_test_set.to_csv(os.path.join(path_cleaned, 'temperature\test_set.csv', index = False))
temp_valid_set.to_csv(os.path.join(path_cleaned, 'temperature\valid_set.csv', index = False))
...
temp_train_set_imp.to_csv(os.path.join(path_cleaned, 'temperature\train_set_imp.csv'), index = False)
temp_test_set_imp.to_csv(os.path.join(path_cleaned, 'temperature\test_set_imp.csv'), index = False)
temp_valid_set_imp.to_csv(os.path.join(path_cleaned, 'temperature\valid_set_imp.csv'), index = False)
...
torch.save(train_loader, os.path.join(path_cleaned,'temperature\train_loader.pt'))
torch.save(valid_loader, os.path.join(path_cleaned,'temperature\valid_loader.pt'))
torch.save(train_seq, os.path.join(path_cleaned,'temperature\train_seq.pt'))
torch.save(valid_seq, os.path.join(path_cleaned,'temperature\valid_seq.pt'))
torch.save(test_seq, os.path.join(path_cleaned,'temperature\test_seq.pt'))
torch.save(valid_loader, os.path.join(path_cleaned,'temperature\valid_loader.pt'))