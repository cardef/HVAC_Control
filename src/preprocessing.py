...
col_temp_out = config['PARAMETER']['DATA']['col_temp_out']
...
energy_train_set, energy_valid_set = split(energy_df, float = 0.9)
...
temp_train_set, temp_valid_set = split(temp_df, float = 0.9)
...
temp_train_loader = DataLoader(Dataset(temp_train_set, time_window, len_forecast, col_temp_in+col_temp_out), batch_size = 64)
temp_valid_loader = DataLoader(Dataset(temp_valid_set, time_window, len_forecast, col_temp_in+col_temp_out), batch_size = 64)
temp_test_loader = DataLoader(Dataset(temp_test_set, time_window, len_forecast, col_temp_in+col_temp_out), batch_size = 64)
